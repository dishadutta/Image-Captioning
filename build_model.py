...
class ImageCaptioningModel(keras.Model):
    ...
    def _compute_loss_and_acc(self, batch_data, training=True):
        ...
        #Pass each of the five captions one by one to the decoder along with the encoder outputs and compute the loss as well as accuracy for each caption.
        for i in range(self.num_captions_per_image):
            with tf.GradientTape() as tape:
                ...
                #Update the batch loss and batch accuracy
                batch_loss += loss
                batch_acc += acc
